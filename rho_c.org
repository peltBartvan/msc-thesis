...
\AZO{} is a promising material for solar cells, as it uniquely combines excellent transparency and conductivity with the ability to directly passivate silicon.
While typical solar cell designs separate the front contact conductivity and passivation functionalities into different layers, \AZO{} might be able to deliver all these qualities in a single layer.

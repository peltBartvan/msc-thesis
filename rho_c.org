...
#+LATEX_HEADER: \newcommand{\source}[1]{\colorbox{blue}{SOURCE: #1}}
...
- Formulering doel :: Goede zonnecellen met AZO contacten.
- Definieer "goede zonnecel" :: Welke zonnecelparameters zijn belangrijk?
...
- Definieer "goed contact" :: contact is losjes gedefinieerd als totale contact stack, dus inclusief passivatie.
  ...
  + Goede interface geleiding :: Mijn onderwerp
...
- Wat kan ik met de data? :: Framing: hoe maak je "goede" contacten?
  ...
  + Contactweerstand :: Wat doen deze parameters nu voor de contactweerstand?
    ...
    - Si doping :: Verlaagt contactweerstand.
      Daling verklaarbaar met Schottky model in Field Emission. \question{or is it? plaatjes zijn normaal omgedraaid qua banddiagram..}
...
** Introduction
- Zoals besproken heeft \AZO{} goede eigenschappen voor zonnecellen, welke? :: Transparant, goede laterale geleiding, meer /abundant/ dan ITO.
- Waarom zijn deze eigenschappen belangrijk? ::
** Background
\question{Misschien beter om dit hoofdstuk te mergen met Theory}
- Wat is er al bekend over \AZO{} contacten? ::
** Theory

...
* COMMENT Zinc oxide contacts for solar cells
** Content
...
- Selectivity
  - Combination with low J0 \source{Jimmy}
    Regenboogplotje
  - Les: we hebben J0 laag bron: paper.
...
The samples were annealed to 400\degree{}C and 500\degree{}C, after which the passivation (not in this work) and contact resistivit

...
Reliability by itself is not enough though, simply because observatios being close to each other does not imply that they are close to the /correct/ value.
...
A CBKR allows for measurements on the exact same samples as on the PCBs, without any alterations.

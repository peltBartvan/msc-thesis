...
These trends can be viewed by the carrier densities and mobilities, which are shown in Figure \ref{fig:capping_n} and Figure \ref{fig:capping_mu_H} respectively.
The deterioration of uncapped films can be attributed to a decrease in both carrier density and mobility.
The decrease in resistivity with doping is found to be attributed to the increased carrier density only, as overall the mobility decreases with doping level.
This decrease in mobility could be caused by increased impurity scattering on Al dopants. \question{doublecheck this.}
...
It has been hypothesized that the increasing mobility in doped samples is caused by clustering of Al at high anneal temperatures, leaving larger regions of intrinsic ZnO.
This however does not account for the higher plasma frequency in intrinsic ZnO than in \AZO{} at these higher temperatures.

#+LABEL: fig:omega_t
#+CAPTION: Scattering frequency of capped samples as function of annealing temperature and doping.
[[./images/omega_t_vs_anneal.png]]

...
As metals have no bandgap, electrons and holes are quick to equilibrate, as a consequence Fermi level splitting is impossible for metals.
...
This enables us to relate electron and hole currents to gradients in Fermi levels:
\begin{equation}
J_n = \frac{\sigma_n}{e} \nabla \EFn{},
\end{equation}
\begin{equation}
...
Some care needs to be taken with this doping however, as an overabundance of free carriers can lead to the three-particle Auger recombination process and photon absorption in the contact.
